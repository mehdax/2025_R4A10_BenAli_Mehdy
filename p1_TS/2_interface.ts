...
Puisque nous trav aillons sur notre génération d'API, nous allons faire un peu d'Orienté Objet
...
class SQLStudentRepository implements StudentRepository {
    ...
    async findOne(id: number): Promise<Student> {
        return Promise.resolve({ id, firstname: '', lastname: '', group: '' });
    }
...
class SQLCourseRepository implements CourseRepository {
    ...
    async findOne(id: number): Promise<Course> {
        return Promise.resolve({ id, name: '', enseignant: '', active: false });
    }
